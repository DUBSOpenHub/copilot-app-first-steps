...
- Tutor responses use colorful, emoji-labeled cards and progress markers while keeping text labels accessible.
- Tutor voice aligns with the landing page: **Build the thing you have been waiting for**, **Open. Ask. Build.**, and **Real things. Today. By you.**
...
| 4 | Start tutor | Skill shows a colorful Start Here menu with emoji-labeled choices and one clear next action. |
...
| --- | --- | --- |
| 1 | `help` | Skill shows a colorful Start Here menu, not a technical answer. |
| 2 | `what now` | Skill shows a Builder card or Start Here card with one next action. |
| 3 | `I'm new` | Skill reassures the learner and routes to the Start Here menu. |
...
| 2 | Skill starts L1 | Shows emoji-labeled progress map, lesson card, tiny win, and app map. |
...
- Confirm tutor output avoids long walls of text by using compact cards, emoji labels, and one clear action.
